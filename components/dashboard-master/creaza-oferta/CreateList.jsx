    ...
    <div className="row mt-2">
      <div className="col-sm-auto">
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="Silver" id="fidelityGradeSilver" />
      ...
      <div className="col-sm-auto">
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="Gold" id="fidelityGradeGold" />
      ...
      <div className="col-sm-auto">
        <div className="form-check">
          <input className="form-check-input" type="checkbox" value="Platinum" id="fidelityGradePlatinum" />
      ...
      <div className="col-lg-12 col-xl-12">
        <div className="my_profile_setting_input ui_kit_select_search form-group">
          ...
          <select
            ...
            data-width="100%"
          >
            <option data-tokens="Status1">Oferta cu discount procentual general</option>
     ...
     <div className="col-lg-4 col-xl-4">
        <div className="my_profile_setting_input form-group">
          ...
          <input type="number" className="form-control" id="fullPrice" value={fullPrice} onChange={(e) => setFullPrice(e.target.value)} placeholder="Introdu prețul întreg"/>
        </div>
      </div>
      {/* End .col */}
      ...
      <div className="col-lg-4 col-xl-4">
        <div className="my_profile_setting_input form-group">
          ...
          <input type="number" className="form-control" id="discountedPrice" value={discountedPrice} onChange={(e) => setDiscountedPrice(e.target.value)} placeholder="Introdu prețul redus"/>
        </div>
      </div>
      {/* End .col */}
      ...
      <div className="col-lg-4 col-xl-4">
        <div className="my_profile_setting_input form-group">
          ...
          <input type="text" className="form-control" id="discountPercentage" value={discountPercentage + '%'} readOnly />
        </div>
      </div>
...
{/* End .col */}
      ...
      <div className="col-xl-12">
        <div className="my_profile_setting_input">
          ...
          <button className="btn btn2 float-end">Adauga</button>
        </div>
      </div>
    </>
  );
